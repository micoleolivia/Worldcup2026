...
function renderRules() {
  ...
  container.innerHTML = `
    <div class="rules-block" style="border:2px solid var(--red);background:rgba(255,71,87,.12);animation:pulse 2s infinite;text-align:center;max-width:600px;margin:0 auto 14px;position:relative;z-index:1">
     ...
     <p style="color:var(--text);margin-top:8px">The winner bet is now <strong>completely free</strong>.No stake, no risk! Pick ONE(!) match per day where you're confident on the winner. Get it right → +5pts. Wrong → nothing lost. Exact bets are unchanged and can be placed on every match.</p>
      </div>
    ...
    <div class="rules-block">
      ...
      <div class="rules-scoring">
        ...
        <div class="rules-score-row"><span class="score-badge silver">Winner</span> Completely free — no stake! Pick one match per day. Get the winner right → +5 points. Wrong → nothing lost.</div>
      </div>
