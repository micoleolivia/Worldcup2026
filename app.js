...
async function resolveBetsForMatch(matchId, actualScore) {
  ...
  state.rescuedPlayers = freshShared.rescuedPlayers || {};
...
// Round buckets: R1 = matchday 1 (IDs ending in 1/2), R2 = matchday 2 (3/4), R3 = matchday 3 (5/6)
  ...
  roundBanner.innerHTML = `<h3 style="color:var(--teal);font-size:1.1rem">🏁 Round 3 is closed 🏁</h3><p style="color:var(--text);font-size:.85rem;margin-top:6px"> Round 3 was taken by Micole!</p>`;
